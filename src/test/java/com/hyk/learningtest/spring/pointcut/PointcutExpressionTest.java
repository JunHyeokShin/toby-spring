package com.hyk.learningtest.spring.pointcut;
...
public class PointcutExpressionTest {
  ...
  public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
    ...
    pointcut.setExpression("execution(public int com.hyk.learningtest.spring.pointcut.Target.minus(int,int) " +
  ...
  public void pointcut() throws Exception {
    ...
    targetClassPointcutMatches("execution(* com.hyk.learningtest.spring.pointcut.Target.*(..))", true, true, true, true, true, false);
    targetClassPointcutMatches("execution(* com.hyk.learningtest.spring.pointcut.*.*(..))", true, true, true, true, true, true);
    targetClassPointcutMatches("execution(* com.hyk.learningtest.spring.pointcut..*.*(..))", true, true, true, true, true, true);
    targetClassPointcutMatches("execution(* com.hyk..*.*(..))", true, true, true, true, true, true);

    targetClassPointcutMatches("execution(* org..*.*(..))", false, false, false, false, false, false);
